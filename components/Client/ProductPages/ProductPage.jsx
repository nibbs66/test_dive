            ...
            <div  className="container flex flex-col  w-screen min-h-fit gap-10 ">
                ...
                <div className="flex flex-col sm:flex-row sm:pl-10 pb-10 items-center">
                    ...
                    <div className="flex flex-col gap-5 w-1/2">
                        ...
                        {product.stock <= 5 && product.stock >0 && <span className={`text-red-500`}>**Only {product.stock} {product.stock > 1 ?'items' : 'item'} in Stock**</span>}
                    ...
                    X
                        ...
                        <div className="flex flex-col items-center justify-center gap-5 mt-5">
                            <button onClick={()=>handleClick(status)}
                                    disabled={lowStock}
                                    className={`disabled:cursor-not-allowed disabled:opacity-30 bg-blue-500 
                                   text-white sm:w-1/2 w-2/3 py-2 rounded uppercase font-bold`}>add to cart</button>
                            {favorites ?
