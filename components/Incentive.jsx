            ...
            <div className="mx-auto max-w-7xl py-24 sm:px-2 sm:py-32 lg:px-4">
                <div className="mx-auto max-w-2xl px-4 lg:max-w-none">
                    <div className="max-w-3xl">
                        <h2 className="text-4xl font-thin tracking-tight text-slate-400 ">
                        ...
                        {incentives.map((incentive) => (
                            <div key={incentive.name} className="sm:flex lg:block">
                                <div className="sm:flex-shrink-0">
                                    <span >{incentive.imageSrc}</span>

                                </div>
                                <div className="mt-4 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
                                    <h3 className="text-sm font-medium text-slate-400">{incentive.name}</h3>
                                    <p className="mt-2 text-sm text-slate-500">{incentive.description}</p>
                                </div>
                            </div>
                        ))}
                    </div>
