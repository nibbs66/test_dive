        ...
        <div  className=" bg-white border-b border-slate-200 z-50">
            ...
            <div className="px-4 sm:px-6 lg:px-10">
                <div className="flex items-center justify-between h-16 ">
                    <span className={'uppercase font-semibold text-slate-500 text-lg'}>👋 Dag {user?.firstName} </span>
                    ...
                    <div className={'flex gap-3 items-center'}>
                        ...
                        <button onClick={()=>signOut()} className={'uppercase text-xs text-white bg-blue-500 py-2 px-3 rounded font-bold'}>Logout</button>
