...
const Pos = ({categories, products}) => {
    ...
    if(total-amountPaid === 0 && purchaseOption ==='takeAway'){
        ...
        res.status === 201 && router.push(`/admin/invoice/sale/${res.data._id}/${medewerker._id}`)
            ...
            EUR
                ...
                <div className={`flex flex-col gap-2 justify-center px-5 mt-5`}>
                    <button
                        ...
                        className={`flex w-full justify-center uppercase px-4 py-4 rounded-md shadow-lg text-center bg-blue-400 hover:bg-blue-600  
