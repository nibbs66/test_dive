        ...
        <div className='flex flex-col items-center w-full'>
                ...
                <div className={`flex flex-col gap-2 text-sm`}>
                    <div className={`flex flex-col gap-1 text-sm`}>
                        <label className='uppercase text-slate-400 font-bold'>username</label>
                        <input
                            ...
                            placeholder={user.personal.username} type="text"/>
                    </div>
                     ...
                     <div className={`flex flex-col gap-1 text-sm`}>
                         ...
                         <input
                             ...
                             className={`border border-slate-400 focus:outline-none rounded text-sm p-1  placeholder:text-slate-300`}
                             placeholder={user.personal.email} type="text"/>
                    </div>
                    <div className={`flex flex-col gap-1 text-sm`}>
                    ...
                    <button className={`py-3 px-4 leading-none uppercase text-white bg-blue-500 hover:bg-blue-600 rounded`}>Update Personal</button>
                </div>
