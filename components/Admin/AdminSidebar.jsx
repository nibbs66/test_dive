...
import { WrenchIcon, AcademicCapIcon, ClockIcon, CalendarDaysIcon, GlobeAltIcon, BuildingStorefrontIcon} from '@heroicons/react/24/outline'
            ...
            <div className={'flex flex-col gap-5 '}>
                ...
                >
                    <ul className={'uppercase text-slate-500 text-xs  mx-2 pb-2 flex flex-col gap-3 '}>
                        ...
                        <li onClick={logOut} className={'flex gap-2 items-center cursor-pointer '}>
                            <Exit/>
                            logout
                        </li>
                ...
                >
                    <ul className={'uppercase text-slate-500 text-xs  mx-2 pb-2 flex flex-col gap-3 '}>
                        ...
                        <Link href="/admin/messages/product" passHref>
                            <li className={'flex gap-2 items-center cursor-pointer '}>
                ...
                >
                    <ul className={'uppercase text-slate-500 text-xs  mx-2 pb-2 flex flex-col gap-3 '}>
                        ...
                        <Link href="/admin/cursus" passHref>
                            <li className={'flex gap-2 items-center cursor-pointer '}>
                                <AcademicCapIcon className={`h-6 w-6`}/>
                                Cursus
                            </li>
