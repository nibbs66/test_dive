                                            ...
                                            <Combobox.Options as="div" static hold className="flex divide-x divide-gray-100">
                                                ...
                                                >
                                                    ...
                                                    <div className="-mx-2 text-sm text-gray-700">
                                                        {(query === '' ? recent : people).map((person) => (
                                                            <Combobox.Option
                                                                as="div"
                                                                key={person.id}
                                                                value={person}
                                                ...
                                                {activeOption && (
                                                    <div className="hidden h-96 w-1/2 flex-none flex-col divide-y divide-gray-100 overflow-y-auto sm:flex">
                                                        <div className="flex-none p-6 text-center">
                                                            <span  className="mx-auto h-24 w-24 p-2 rounded-full font-bold bg-indigo-600 text-white" >
                                                                {activeOption.firstName[0].toUpperCase()+activeOption.lastName[0].toUpperCase()}
                                                            </span>
                                                        ...
                                                        <div className="flex flex-auto flex-col justify-between p-6">
                                                            ...
                                                            <button
                                                                type="button"
                                                                className="uppercase mt-6 w-full rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                                            >
                                                                Submit
                                                            </button>
                                                        </div>
